...
void Logger::pushValue(const char value) { pushValue(LogElement{LogType::CHAR, {.c = value}}); }
...
void Logger::pushValue(const int value) { pushValue(LogElement{LogType::INTEGER, {.i = value}}); }
...
void Logger::pushValue(const float value) { pushValue(LogElement{LogType::FLOAT, {.f = value}}); }

void Logger::pushValue(const double value) { pushValue(LogElement{LogType::DOUBLE, {.d = value}}); }

void Logger::pushValue(const std::string& value) { pushValue(value.c_str()); }
